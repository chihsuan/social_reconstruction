...
def list_match(threshold, face_list1, face_list2):
    
    for face1 in face_list1:
        for face2 in face_list2:
            if match(threshold,face1['img'], face2['img']):
                return True
...
def match(minCount, face1, face2, detctor_type='sift'):

    detector, matcher = init_feature(detctor_type)
...
def get_match_rate(face1, face2, detctor_type='sift'):
