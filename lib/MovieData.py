...
class MovieData(object):
    ...
    def  __init__(self, preprcessedFile):
        self.preprcessedFile = preprcessedFile
    
    #read  data that was already proceessed
    def getFaceAndKeyword(self, characterNumber, outputPath):
    ...
    def loadCharacter(self, characterFile):
